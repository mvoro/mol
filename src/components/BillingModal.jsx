...
function Reviews({ className = '' }) {
  return <div className={`billing-reviews ${className}`}>
    ...
    <div><div className="billing-rating"><img src={ASSET + 'notif-final-0-c99b8.svg'} width="77" height="13" alt="" /><strong>4,8</strong></div><span>Оценка 15 000+ пользователей</span></div>
  </div>;
}
